...
if (isset($_GET['id'])) {
    if (!empty($_POST)) {
        ...
        // Update the record
        $query = "UPDATE details SET firstname = :firstname, lastname = :lastname, email = :email, phone = :phone, arrivaldate = :arrival, depdate = :departure, adults = :adults, children = :children, roomnum = :roomnum , street1 = :address1, street2 = :address2, country = :country, zip_code = :zip_code, state = :state, payment_type = :pymttype WHERE id = :id";
        $stmt = $pdo->prepare($query);
        if ($stmt->execute([$firstname, $lastname, $phone,$email, $arrival, $departure, $adults, $children, $roomnum, $address1, $address2, $country, $state, $zip_code, $pymttype, $_GET['id']])) {
...
<!-- <div class="content update"> -->
            ...
            <div class="fields">
                ...
                <div class="wrapper">
                    ...
                    <div>
                        ...
                        <div class="field">
						<input id="phone" type="text" name="phone" placeholder="Phone" value= "<?php echo $row['phone']; ?>"required />
                ...
                <div class="field">
                <input id="address2" type="text" name="address2" placeholder="address Line 2" value= "<?php echo $row['street2']; ?>"required />
    ...
    <option value="Zimbabwe">Zimbabwe</option>
					...
					<label for="state">State</label>
                        <div class="field">
                        <input id="state" type="text" name="state" placeholder="State" value= "<?php echo $row['state']; ?>"required />
                ...
                <div class="wrapper">
                    <div>
                        ...
                        <div class="field">
                        <input id="arrival" type="date" name="arrival" placeholder="Arrival date" value= "<?php echo $row['arrivaldate']; ?>"required />
                    ...
                    <div>
                        ...
                        <div class="field">
                        <input id="departure" type="date" name="departure" placeholder="Departure date" value= "<?php echo $row['depdate']; ?>"required />
